<?php
$title = "Manajemen Data Tiket Velvet";

require_once __DIR__ . '/../Service/TiketVelvet.php';

$tiket = new \TiketVelvet(null, null, null, null, null, null, null);
...
<div class="px-4 sm:px-6 lg:px-8 mt-4">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold text-gray-900 dark:text-white">Data Tiket Velvet</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Daftar seluruh tiket Velvet yang tersedia.</p>
        </div>
    </div>
                ...
                <table class="min-w-full border-separate border-spacing-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars($tiket_item['bantal_selimut_pack']) ?>
                            </td>
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars($tiket_item['layanan_butler']) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else : ?>
