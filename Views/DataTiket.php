<?php
$title = "Manajemen Data Tiket";

require_once '../Koneksi/Database.php';
require_once '../Service/Tiket.php';

// Karena Tiket adalah abstract class, kita butuh concrete class untuk membuat instance
// Kita buat saja class sementara di sini
class TiketDummy extends Tiket {
    public function hitungTotalHarga() { return 0; }
    public function tampilkanInfoFasilitas() { return ""; }
}

$tiket = new TiketDummy();
...
<div class="px-4 sm:px-6 lg:px-8 mt-4">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold text-gray-900 dark:text-white">Data Tiket</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Daftar seluruh tiket yang tersedia.</p>
        </div>
    </div>
                ...
                <table class="min-w-full border-separate border-spacing-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars($tiket_item['jenis_studio']) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else : ?>
