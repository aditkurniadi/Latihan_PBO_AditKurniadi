<?php
$title = "Manajemen Data Tiket IMAX";

require_once __DIR__ . '/../Koneksi/Database.php';
require_once __DIR__ . '/../Service/Tiket.php';
require_once __DIR__ . '/../Service/TiketIMAX.php';

$tiket = new \TiketIMAX(null, null, null, null, null, null, null);
...
<div class="px-4 sm:px-6 lg:px-8 mt-4">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-base font-semibold text-gray-900 dark:text-white">Data Tiket IMAX</h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">Daftar seluruh tiket IMAX yang tersedia.</p>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td
                                ...
                                <?= htmlspecialchars((string)($tiket_item['id_tiket'] ?? '')) ?>
                            </td>
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars((string)($tiket_item['nama_film'] ?? '')) ?>
                            </td>
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars((string)($tiket_item['jadwal_tayang'] ?? '')) ?>
                            </td>
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars((string)($tiket_item['jumlah_kursi'] ?? '')) ?>
                            </td>
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                            ...
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars((string)($tiket_item['kacamata_3d_id'] ?? '')) ?>
                            </td>
                            <td
                                class="<?= $borderClass ?> px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                <?= htmlspecialchars((string)($tiket_item['efek_gerak_fitur'] ?? '')) ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                        <?php else : ?>
